...
def main():
    ...
    for modality in config.modalities:
        ...
        result_dir = config.result_dir + modality +'/'
        # todo: why exclude pereira??
        datasets = config.datasets[modality]
        ...
        report = '/Users/norahollenstein/Desktop/PhD/projects/testing/reports/fmri/' + config.test + '-test.json'
